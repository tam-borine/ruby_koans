...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_plus_means_one_or_more
    assert_equal "bccc" ,"abbcccddddeeeee"[/bc+/] #why bccc and not bbccc?????
  end
  ...
  def test_the_left_most_match_wins
    assert_equal "a", "abbccc az"[/az*/] #if there are more of one than the other, return the one that has more
  end
  ...
  def test_slash_b_anchors_to_a_word_boundary #what does this mean word boundary?
  ...
  def test_variables_can_also_be_used_to_access_captures
    ...
    assert_equal "Gray", $1  #is dollar sign storing this??? 
